...
if ( ! function_exists( 'ppa_videos_fetch_playlist_videos' ) ) {                                              // CHANGED:
        ...
        function ppa_videos_fetch_playlist_videos( $playlist_id, $max_items = 30, $force_refresh = false ) {          // CHANGED:
                ...
                // Load playlist feed URL.                                                                               // CHANGED:
                // IMPORTANT: Do NOT use fetch_feed() for YouTube playlist feeds here.                                    // CHANGED:
                // On this site, fetch_feed() truncates items (e.g., raw feed has 2 entries but fetch_feed returns 1).   // CHANGED:
                // We rely on the direct XML parse fallback below + our plugin transient for deterministic results.      // CHANGED:
